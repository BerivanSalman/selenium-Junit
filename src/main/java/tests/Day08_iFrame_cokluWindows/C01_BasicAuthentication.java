...
public class C01_BasicAuthentication extends TestBase {
    ...
    public void basicAuntenticationTest(){
        //API bize sifre ve kullanıcı adını vermelidir ve biz de onu url e girmeliyiz. O zaman anlar bizim onun kullanıcısı oldugumuzu
        //https://testotomasyonu.com/basicauth sayfasina gidin
       // driver.get("https://testotomasyonu.com/basicauth"); boyle yapip gidince inspect yapamıyoruz.
        // Oyüzden asagıda soyledigi gibi gitmeliyiz
